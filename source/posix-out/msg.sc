(%line 1 "csample/posix-header/msg.h")
...
(%line 122 "/usr/include/sys/ipc.h")
(decl (csym::ftok) (fn csym::key_t (ptr (const char)) int))
(%line 37 "csample/posix-header/msg.h")
...
(%line 66 "csample/posix-header/msg.h")
(def (struct csym::msqid_ds) (decl csym::msg_perm (struct csym::ipc_perm))
 ...
 (decl csym::msg_qbytes csym::msglen_t) (decl csym::msg_lspid csym::pid_t)
 (decl csym::msg_lrpid csym::pid_t) (decl csym::msg_stime csym::time_t)
 (decl csym::msg_pad1 long) (decl csym::msg_rtime csym::time_t)
 (decl csym::msg_pad2 long) (decl csym::msg_ctime csym::time_t)
 (decl csym::msg_pad3 long) (decl csym::msg_pad4 (array long 4)))
(%line 95 "csample/posix-header/msg.h")
(def (struct csym::mymsg) (decl csym::mtype long)
 (decl csym::mtext (array char 1)))
(%line 125 "csample/posix-header/msg.h")
...
(%defconstant csym::__@TIME__ "22:25:11")
