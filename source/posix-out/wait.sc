(%line 1 "csample/posix-header/wait.h")
...
(%line 102 "csample/posix-header/wait.h")
...
(%defconstant csym::__@TIME__ "16:01:53")
...
(%defmacro csym::_@W_INT (csym::_arg0)
 (common-lisp:list 'mref
                   (common-lisp:list 'cast
                                     ...
                                     (common-lisp:list 'ptr csym::_arg0))))
(%defconstant csym::@WCOREFLAG 128)
(%defmacro csym::_@WSTATUS (csym::_arg0)
 (common-lisp:list 'bit-and (common-lisp:list 'csym::_@W_INT csym::_arg0) '127))
(%defconstant csym::_@WSTOPPED 127)
(%defmacro csym::@WIFSTOPPED (csym::_arg0)
 (common-lisp:list '==
                   (common-lisp:list 'csym::_@WSTATUS csym::_arg0)
                   'csym::_@WSTOPPED))
(%defmacro csym::@WSTOPSIG (csym::_arg0)
 (common-lisp:list '>> (common-lisp:list 'csym::_@W_INT csym::_arg0) '8))
(%defmacro csym::@WIFSIGNALED (csym::_arg0)
 (common-lisp:list 'and
                   (common-lisp:list '!=
                                     (common-lisp:list 'csym::_@WSTATUS
                                                       csym::_arg0)
                                     'csym::_@WSTOPPED)
                   (common-lisp:list '!=
                                     (common-lisp:list 'csym::_@WSTATUS
                                                       csym::_arg0)
                                     '0)))
(%defmacro csym::@WTERMSIG (csym::_arg0)
 (common-lisp:list 'csym::_@WSTATUS csym::_arg0))
(%defmacro csym::@WIFEXITED (csym::_arg0)
 (common-lisp:list '== (common-lisp:list 'csym::_@WSTATUS csym::_arg0) '0))
(%defmacro csym::@WEXITSTATUS (csym::_arg0)
 (common-lisp:list '>> (common-lisp:list 'csym::_@W_INT csym::_arg0) '8))
(%defmacro csym::@WIFCONTINUED (csym::_arg0)
 (common-lisp:list '== csym::_arg0 '19))
(%defmacro csym::@WCOREDUMP (csym::_arg0)
 (common-lisp:list 'bit-and
                   (common-lisp:list 'csym::_@W_INT csym::_arg0)
                   'csym::@WCOREFLAG))
(%defmacro csym::@W_EXITCODE (csym::_arg0 csym::_arg1)
 (common-lisp:list 'bit-or (common-lisp:list '<< csym::_arg0 '8) csym::_arg1))
