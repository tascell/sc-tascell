(%line 1 "csample/posix-header/regex.h")
...
(%line 48 "csample/posix-header/regex.h")
(deftype csym::regoff_t csym::__off_t)
(deftype csym::size_t csym::__size_t)
(def (struct csym::unnamed1) (decl csym::re_magic int)
 (decl csym::re_nsub csym::size_t) (decl csym::re_endp (ptr (const char)))
 (decl csym::re_g (ptr (struct csym::re_guts))))
(deftype csym::regex_t (struct csym::unnamed1))
(def (struct csym::unnamed2) (decl csym::rm_so csym::regoff_t)
 (decl csym::rm_eo csym::regoff_t))
(deftype csym::regmatch_t (struct csym::unnamed2))
(%line 107 "csample/posix-header/regex.h")
...
(%line 115 "csample/posix-header/regex.h")
(decl (csym::regexec)
...
(%defconstant csym::__@TIME__ "22:44:33")
