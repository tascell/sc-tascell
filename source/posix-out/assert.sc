(%line 1 "csample/posix-header/assert.h")
(%line 1 "/usr/include/sys/cdefs.h")
(%line 62 "csample/posix-header/assert.h")
(decl (csym::__assert)
...
(%defconstant csym::__@DATE__ "Feb 11 2005")
(%defconstant csym::__@TIME__ "18:29:27")
...
(%defmacro csym::__asm (csym::arg0) (common-lisp:list 'c-exp ""))
(%undef csym::i386)
(%undef csym::unix)
...
(%defmacro csym::__offsetof (csym::arg0 csym::arg1)
 (common-lisp:list 'c-exp "((size_t)(&((~a  *)0)->~a ))" csym::arg0 csym::arg1))
...
(%defmacro csym::_assert (csym::arg0)
 (common-lisp:list 'csym::assert csym::arg0))
(%defmacro csym::assert (csym::arg0)
 (common-lisp:list 'if-exp
                   csym::arg0
                   (common-lisp:list 'cast 'void '0)
                   (common-lisp:list 'csym::__assert
                                     'csym::__func__
                                     'csym::__@FILE__
                                     'csym::__@LINE__
                                     (common-lisp:list 'csym::_@C2SC_STRINGIFY
                                                       csym::arg0))))
