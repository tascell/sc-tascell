(%line 1 "csample/posix-header/wordexp.h")
...
(%line 36 "csample/posix-header/wordexp.h")
(deftype csym::size_t csym::__size_t)
(def (struct csym::unnamed1) (decl csym::we_wordc csym::__size_t)
...
(deftype csym::wordexp_t (struct csym::unnamed1))
(%line 70 "csample/posix-header/wordexp.h")
