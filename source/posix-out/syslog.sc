(%line 1 "csample/posix-header/syslog.h")
...
(%line 191 "csample/posix-header/syslog.h")
...
(%defconstant csym::__@TIME__ "14:29:12")
...
(%defmacro csym::@LOG_PRI (csym::_arg0)
 (common-lisp:list 'bit-and csym::_arg0 'csym::@LOG_PRIMASK))
(%defmacro csym::@LOG_MAKEPRI (csym::_arg0 csym::_arg1)
 (common-lisp:list 'bit-or csym::_arg0 csym::_arg1))
...
(%defmacro csym::@LOG_FAC (csym::_arg0)
 (common-lisp:list '>>
                   (common-lisp:list 'bit-and csym::_arg0 'csym::@LOG_FACMASK)
                   '3))
(%defmacro csym::@LOG_MASK (csym::_arg0) (common-lisp:list '<< '1 csym::_arg0))
(%defmacro csym::@LOG_UPTO (csym::_arg0)
 (common-lisp:list '-
                   (common-lisp:list '<<
                                     '1
                                     (common-lisp:list '+ csym::_arg0 '1))
                   '1))
