(%line 1 "csample/posix-header/glob.h")
(%line 1 "/usr/include/sys/cdefs.h")
(%line 45 "csample/posix-header/glob.h")
(def (struct csym::unnamed0) (decl csym::gl_pathc int)
 ...
 (decl csym::gl_stat
  (ptr (fn int (ptr (const char)) (ptr (struct csym::stat))))))
(deftype csym::glob_t (struct csym::unnamed0))
(%line 60 "csample/posix-header/glob.h")
(%line 98 "csample/posix-header/glob.h")
(decl (csym::glob)
...
(%defconstant csym::__@TIME__ "21:28:58")
