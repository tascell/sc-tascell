(%line 1 "csample/posix-header/search.h")
...
(%line 16 "csample/posix-header/search.h")
...
(def (enum csym::unnamed1) (csym::@FIND csym::@ENTER))
(deftype csym::@ACTION (enum csym::unnamed1))
(def (enum csym::unnamed2)
 (csym::preorder csym::postorder csym::endorder csym::leaf))
(deftype csym::@VISIT (enum csym::unnamed2))
(%line 48 "csample/posix-header/search.h")
...
(%defconstant csym::__@TIME__ "22:46:21")
