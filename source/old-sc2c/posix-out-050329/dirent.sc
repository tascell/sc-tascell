(%line 1 "csample/posix-header/cpio.h")
(%line 1 "csample/posix-header/dirent.h")
...
(%line 62 "csample/posix-header/dirent.h")
...
(%line 94 "csample/posix-header/dirent.h")
...
(%defconstant csym::__@TIME__ "16:12:01")
...
(%defmacro csym::@IFTODT (csym::_arg0)
 (common-lisp:list '>> (common-lisp:list 'bit-and csym::_arg0 '61440) '12))
(%defmacro csym::@DTTOIF (csym::_arg0) (common-lisp:list '<< csym::_arg0 '12))
...
(%defmacro csym::dirfd (csym::_arg0)
 (common-lisp:list 'fref (common-lisp:list 'mref csym::_arg0) 'csym::dd_fd))
