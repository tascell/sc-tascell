...
LGOTO:switch ((*efp).call_id) {
  ...
  *((char **)esp) = 0;
  ...
  if (0 > (*pthis).n2) {
    ...
    {
      new_esp = esp;
      while (__builtin_expect(((tmp = cmp_1(new_esp, &efp->_bk, _thr, (*pthis).n1, (*pthis).n2, (*pthis).d1, (*pthis).d2)) == (int)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
	efp->tmp = tmp;
	efp->j = j;
	efp->i = i;
	efp->pthis = pthis;
    ...
    new_esp = esp;
    while (__builtin_expect(((tmp2 = cmp_1(new_esp, &efp->_bk, _thr, (*pthis).n1, (*pthis).n2, (*pthis).d1, (*pthis).d2)) == (int)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
      efp->tmp2 = tmp2;
      efp->tmp = tmp;
      efp->j = j;
      efp->i = i;
  ...
  *((char **)esp) = 0;
  ...
  if (n1 > n2) {
	...
	L_CALL3:;
	  ...
	  new_esp = esp;
	  while (__builtin_expect(((s1 = cmp_1(new_esp, &efp->do_two_bk, _thr, n1_1, n2, d1, d2)) == (int)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
	    efp->spawned = spawned;
	    efp->pthis = pthis;
	    efp->n1_2 = n1_2;
	    efp->n1_1 = n1_1;
	...
	new_esp = esp;
	while (__builtin_expect(((s2 = cmp_1(new_esp, _bk, _thr, n1_2, n2, d1 + n1_1, d2)) == (int)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
	  efp->spawned = spawned;
	  efp->pthis = pthis;
	  efp->n1_2 = n1_2;
	  efp->n1_1 = n1_1;
	...
	L_CALL7:;
	  ...
	  new_esp = esp;
	  while (__builtin_expect(((s1 = cmp_1(new_esp, &efp->do_two_bk2, _thr, n1, n2_1, d1, d2)) == (int)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
	    efp->spawned2 = spawned2;
	    efp->pthis2 = pthis2;
	    efp->n2_2 = n2_2;
	    efp->n2_1 = n2_1;
	...
	new_esp = esp;
	while (__builtin_expect(((s2 = cmp_1(new_esp, _bk, _thr, n1, n2_2, d1, d2 + n2_1)) == (int)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
	  efp->spawned2 = spawned2;
	  efp->pthis2 = pthis2;
	  efp->n2_2 = n2_2;
	  efp->n2_1 = n2_1;
