...
void		decomp_lu (int (*_bk) closure(void), struct thread_data *_thr, int n, double *a, int nx, int anx);

void		decomp_r  (int (*_bk) closure(void), struct thread_data *_thr, int n1, int n2, double *b, double *a, int nx, int an);

void		decomp_d  (int (*_bk) closure(void), struct thread_data *_thr, int n1, int n2, double *b, double *a, int nx, int an);

void		decomp_rd (int (*_bk) closure(void), struct thread_data *_thr, int n1, int n2, int n3, double *b1, double *b2, double *a, int nx, int anx);
...
void		decomp_r  (int (*_bk) closure(void), struct thread_data *_thr, int n1, int n2, double *b, double *a, int nx, int anx){
  if (n1 <= 4) {
...
void		decomp_d  (int (*_bk) closure(void), struct thread_data *_thr, int n1, int n2, double *b, double *a, int nx, int anx){
  if (n2 <= 4) {
...
void		decomp_lu_1(int (*_bk) closure(void), struct thread_data *_thr, int n, double *a, int nx, int anx){
  int		  i;
...
void		proc_cmd  (int (*_bk) closure(void), struct thread_data *_thr, int n1, int n2, int n3, double *ansp){
  struct timeval  tp[2];
  int		  n = n1;
  int		  al = n2;
  int		  d = n3;
