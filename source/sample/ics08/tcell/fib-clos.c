...
LGOTO:;
  ...
  esp =
      (char *)((Align_t *) esp + (sizeof(struct _bk_in_do_fib_task_frame) +
...
LGOTO:;
  ...
  esp =
      (char *)((Align_t *) esp + (sizeof(struct do_fib_task_frame) +
	  sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  efp->_thr = _thr;
  efp->pthis = pthis;
...
LGOTO:;
  ...
  esp =
      (char *)((Align_t *) esp + (sizeof(struct do_two_bk_in_fib_frame) +
	  sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  efp->xfp = xfp;
  if (xfp->spawned) {
...
LGOTO:;
  ...
  esp =
      (char *)((Align_t *) esp + (sizeof(struct fib_frame) + sizeof(Align_t) +
	  -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  efp->_bk = _bk;
  efp->_thr = _thr;
  ...
  if (efp->n <= 2)
	...
	send_divisible();
      ...
      {
	if ((*efp->_thr).req)
	  while (handle_req(esp, &efp->do_two_bk, efp->_thr), (efp->tmp_esp =
		  *((char **)esp)) != 0) {
	    if ((char *)efp->tmp_esp < (char *)efp)
	      return (int)0 - 1;
	    efp->tmp_esp = 0;
	...
	while ((efp->s1 =
		fib(esp, &efp->do_two_bk, efp->_thr, efp->n - 1)) == (int)0 - 1
	    && (efp->tmp_esp = *((char **)esp)) != 0) {
	  if ((char *)efp->tmp_esp < (char *)efp)
	    return (int)0 - 1;
	  efp->tmp_esp = 0;
	...
	while ((efp->s2 =
		fib(esp, efp->_bk, efp->_thr, efp->n - 2)) == (int)0 - 1
	    && (efp->tmp_esp = *((char **)esp)) != 0) {
	  if ((char *)efp->tmp_esp < (char *)efp)
	    return (int)0 - 1;
	  efp->tmp_esp = 0;
