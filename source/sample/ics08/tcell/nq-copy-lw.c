      ...
      ai = ((*tsk).a)[i];
      {
        ...
        if (!ifexp_result5)
          if (k == n - 1) {
            ...
            {
              new_esp = esp;
              while (__builtin_expect((tmp = nqueens(new_esp, &efp->do_many_bk, _thr, n, k + 1, k + 1, n, st)) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
                efp->tmp = tmp;
                efp->ai = ai;
...
LGOTO:switch ((*efp).call_id) {
  ...
  *((char **)esp) = 0;
  ...
  if (k < 0) {
    ...
    {
      new_esp = esp;
      while (__builtin_expect((tmp3 = nqueens(new_esp, &efp->_bk, _thr, n, 0, 0, n, &(*pthis))) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
        efp->tmp3 = tmp3;
        efp->k = k;
        efp->n = n;
        efp->i = i;
    ...
    new_esp = esp;
    while (__builtin_expect((tmp4 = nqueens(new_esp, &efp->_bk, _thr, n, k, (*pthis).i1, (*pthis).i2, &(*pthis))) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
      efp->tmp4 = tmp4;
      efp->tmp3 = tmp3;
      efp->k = k;
      efp->n = n;
