...
LGOTO:switch ((*efp).call_id) {
  ...
  *((char **)esp) = 0;
  ...
  {
    new_esp = esp;
    while (__builtin_expect((tmp = search(new_esp, &efp->_bk, _thr, k, i0, i1, i2, &(*pthis))) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
      efp->i2 = i2;
      efp->i1 = i1;
      efp->i0 = i0;
      efp->k = k;
...
LGOTO:switch ((*efp).call_id) {
  ...
  *((char **)esp) = 0;
  ...
  {
    new_esp = esp;
    while (__builtin_expect((tmp2 = search(new_esp, &efp->_bk, _thr, 0, 0, 0, 12, &efp->pen)) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
      efp->i = i;
      efp->tmp2 = tmp2;
      efp->pthis = pthis;
      efp->_thr = _thr;
            ...
            {
              {
                ...
                if (kk == 70) {
                  ...
                  if (ifexp_result7) {
                    ...
                    new_esp = esp;
                    while (__builtin_expect((tmp3 = search(new_esp, &efp->dwind_bk, _thr, kk, j0 + 1, j0 + 1, 12, tsk)) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
                      efp->tmp3 = tmp3;
