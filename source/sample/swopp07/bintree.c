...
newBintree (char *esp, sht scan0, int k, int v)
{
  ...
  *((char **) esp) = 0;
  new_esp = esp;
  tmp_arg = &Bintree_d;
  while ((tmp3 = getmem (new_esp, scan0, tmp_arg)) == (void *) 0 - 1
	 && (efp->tmp_esp = *((char **) esp)) != 0)
    {
      efp->tmp3 = tmp3;
      efp->p = p;
  ...
  *((char **) esp) = 0;
  ...
  (efp->seed)[2] = 5;
  {
      ...
      do
	{
	  k = nrand48 (efp->seed);
	  new_esp = esp;
	  while (insert (new_esp, &efp->scan1, this, k, k),
		 (efp->tmp_esp = *((char **) esp)) != 0)
	    {
	      efp->k = k;
	      efp->i = i;
  ...
  *((char **) esp) = 0;
  ...
  (efp->seed)[2] = 10;
  {
      ...
      do
	{
	  k = nrand48 (efp->seed);
	  new_esp = esp;
	  while (search (new_esp, &efp->scan1, this, k, 0),
		 (efp->tmp_esp = *((char **) esp)) != 0)
	    {
	      efp->k = k;
	      efp->i = i;
...
lgoto:
  ...
  *((char **) esp) = 0;
  ...
  new_esp = esp;
  tmp_arg2 = &Bintree_d;
  while ((root = getmem (new_esp, &efp->scan1, tmp_arg2)) == (void *) 0 - 1
	 && (efp->tmp_esp = *((char **) esp)) != 0)
    {
      char *goto_fr;
  ...
  new_esp = esp;
  while (randinsert (new_esp, &efp->scan1, root, maxins),
	 (efp->tmp_esp = *((char **) esp)) != 0)
    {
      char *goto_fr;
  ...
  if (!searchskip)
    {
      new_esp = esp;
      while (randsearch (new_esp, &efp->scan1, root, maxsearch),
	     (efp->tmp_esp = *((char **) esp)) != 0)
	{
	  char *goto_fr;
