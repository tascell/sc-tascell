...
(%defconstant csym::__@TIME__ "10:50:11")
...
(%defmacro csym::fropen (csym::arg0 csym::arg1)
 (common-lisp:list 'csym::funopen csym::arg0 csym::arg1 '0 '0 '0))
(%defmacro csym::fwopen (csym::arg0 csym::arg1)
 (common-lisp:list 'csym::funopen csym::arg0 '0 csym::arg1 '0 '0))
                   ...
                   (common-lisp:list '<
                                     (common-lisp:list '--
                                                       (common-lisp:list 'fref
                                                                         ...
                                                                         'csym::_r))
                                     '0)
                   (common-lisp:list 'csym::__srget csym::arg0)
                   (common-lisp:list 'cast
                                     'int
                                     (common-lisp:list 'mref
...
(%defmacro csym::__sfileno (csym::arg0)
 (common-lisp:list 'fref (common-lisp:list 'mref csym::arg0) 'csym::_file))
(%defmacro csym::feof (csym::arg0)
 (common-lisp:list 'if-exp
                   (common-lisp:list 'not 'csym::__isthreaded)
                   (common-lisp:list 'csym::__sfeof csym::arg0)
                   (common-lisp:list 'csym::feof csym::arg0)))
(%defmacro csym::ferror (csym::arg0)
 (common-lisp:list 'if-exp
                   (common-lisp:list 'not 'csym::__isthreaded)
                   (common-lisp:list 'csym::__sferror csym::arg0)
                   (common-lisp:list 'csym::ferror csym::arg0)))
(%defmacro csym::clearerr (csym::arg0)
 (common-lisp:list 'if-exp
                   (common-lisp:list 'not 'csym::__isthreaded)
                   (common-lisp:list 'csym::__sclearerr csym::arg0)
                   (common-lisp:list 'csym::clearerr csym::arg0)))
(%defmacro csym::fileno (csym::arg0)
 (common-lisp:list 'if-exp
                   (common-lisp:list 'not 'csym::__isthreaded)
                   (common-lisp:list 'csym::__sfileno csym::arg0)
                   (common-lisp:list 'csym::fileno csym::arg0)))
(%defmacro csym::getc (csym::arg0)
 (common-lisp:list 'if-exp
                   (common-lisp:list 'not 'csym::__isthreaded)
                   (common-lisp:list 'csym::__sgetc csym::arg0)
                   (common-lisp:list 'csym::getc csym::arg0)))
(%defmacro csym::putc (csym::arg0 csym::arg1)
 (common-lisp:list 'if-exp
                   (common-lisp:list 'not 'csym::__isthreaded)
                   (common-lisp:list 'csym::__sputc csym::arg0 csym::arg1)
                   (common-lisp:list 'csym::putc csym::arg0 csym::arg1)))
(%defmacro csym::getchar common-lisp:nil
 (common-lisp:list 'csym::getc 'csym::stdin))
(%defmacro csym::putchar (csym::arg0)
 (common-lisp:list 'csym::putc csym::arg0 'csym::stdout))
...
(%defmacro csym::putchar_unlocked (csym::arg0)
 (common-lisp:list 'csym::putc_unlocked csym::arg0 'csym::stdout))
