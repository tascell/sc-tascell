...
;; [07/12/28]
;; 下のareq案はやめて：
;; treqがきたとき，まったく仕事がないならすぐさまnoneを返す（worker2.sc時点といっしょ）
;; （ノードを跨る場合，このnoneはTascellサーバに引き止められ，サーバから再びtreqを送る）
;; Tascellサーバはtaskコマンドを送ったところには仕事があるとわかるのでdvblは不要
;; [07/??/??]
