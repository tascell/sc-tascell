...
void decomp_lu (char *esp, closure_t * _bk, struct thread_data *_thr, int n,
                double *a, int nx, int anx);

void decomp_r (char *esp, closure_t * _bk, struct thread_data *_thr, int n1,
               int n2, double *b, double *a, int nx, int an);

void decomp_d (char *esp, closure_t * _bk, struct thread_data *_thr, int n1,
               int n2, double *b, double *a, int nx, int an);

void decomp_rd (char *esp, closure_t * _bk, struct thread_data *_thr, int n1,
...
char *
do_two_bk_in_decomp_lu (char *esp, void *xfp0)
{
  char *new_esp;
...
LGOTO:;
  ...
  esp =
    (char *) ((Align_t *) esp +
              (sizeof (struct do_two_bk_in_decomp_lu_frame) +
  ...
  *((char **) esp) = 0;
  ...
  if ((*xfp->_thr).treq_top)
    {
      put_task (&(*xfp->pthis), TASK_D, xfp->n1, xfp->n2, 0, xfp->a, 0,
                xfp->a + xfp->n1 * xfp->nx, xfp->nx, xfp->anx);
      xfp->spawned = 1;
...
void
decomp_lu (char *esp, closure_t * _bk, struct thread_data *_thr, int n,
           double *a, int nx, int anx)
{
  ...
  if (esp_flag)
    {
      ...
      esp =
        (char *) ((Align_t *) esp +
                  (sizeof (struct decomp_lu_frame) + sizeof (Align_t) +
                   -1) / sizeof (Align_t));
      *((char **) esp) = 0;
  ...
  *((char **) esp) = 0;
    ...
    }
  {
      ...
      }
    {
      ...
      n2 = n - n1;
      new_esp = esp;
      while (decomp_lu (new_esp, _bk, _thr, n1, a, nx, anx),
        ...
        }
      {
        ...
        spawned = 0;
        {
            ...
            }
          {
            new_esp = esp;
            while (decomp_r
                   (new_esp, &efp->do_two_bk, _thr, n1, n2, a, a + n1, nx,
                    anx), __builtin_expect ((efp->tmp_esp =
                                             *((char **) esp)) != 0, 0))
              {
                efp->spawned = spawned;
                efp->pthis = pthis;
        ...
        if (spawned)
        ...
        else
          {
            new_esp = esp;
            while (decomp_d
                   (new_esp, _bk, _thr, n1, n2, a, a + n1 * nx, nx, anx),
                   __builtin_expect ((efp->tmp_esp =
                                      *((char **) esp)) != 0, 0))
              {
                efp->spawned = spawned;
      ...
      new_esp = esp;
      while (decomp_rd
             (new_esp, _bk, _thr, n1, n2, n2, a + n1 * nx, a + n1,
              a + n1 * nx + n1, nx, anx), __builtin_expect ((efp->tmp_esp =
                                                             *((char **) esp))
                                                            != 0, 0))
        {
          efp->spawned = spawned;
      ...
      new_esp = esp;
      while (decomp_lu (new_esp, _bk, _thr, n2, a + n1 * nx + n1, nx, anx),
             __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
        {
          efp->spawned = spawned;
          efp->pthis = pthis;
...
void
decomp_r (char *esp, closure_t * _bk, struct thread_data *_thr, int n1,
          int n2, double *b, double *a, int nx, int anx)
{
  ...
  if (esp_flag)
    {
      ...
      esp =
        (char *) ((Align_t *) esp +
                  (sizeof (struct decomp_r_frame) + sizeof (Align_t) +
                   -1) / sizeof (Align_t));
      *((char **) esp) = 0;
    LGOTO:switch ((*efp).call_id)
        {
  ...
  *((char **) esp) = 0;
    ...
    }
  {
    ...
    n1_2 = n1 - n1_1;
    new_esp = esp;
    while (decomp_r (new_esp, _bk, _thr, n1_1, n2, b, a, nx, anx),
           __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
      {
        efp->n1_2 = n1_2;
        efp->n1_1 = n1_1;
    ...
    new_esp = esp;
    while (decomp_rd
           (new_esp, _bk, _thr, n1_1, n1_2, n2, b + n1_1 * nx, a,
            a + n1_1 * nx, nx, anx), __builtin_expect ((efp->tmp_esp =
                                                        *((char **) esp)) !=
                                                       0, 0))
      {
        efp->n1_2 = n1_2;
    ...
    new_esp = esp;
    while (decomp_r
           (new_esp, _bk, _thr, n1_2, n2, b + (n1_1 * nx + n1_1),
            a + n1_1 * nx, nx, anx), __builtin_expect ((efp->tmp_esp =
                                                        *((char **) esp)) !=
                                                       0, 0))
      {
...
char *
do_two_bk2_in_decomp_d (char *esp, void *xfp0)
{
  char *new_esp;
...
LGOTO:;
  ...
  esp =
    (char *) ((Align_t *) esp +
              (sizeof (struct do_two_bk2_in_decomp_d_frame) +
               sizeof (Align_t) + -1) / sizeof (Align_t));
  *((char **) esp) = 0;
  if (xfp->spawned2)
    {
  ...
  if ((*xfp->_thr).treq_top)
    {
      put_task (&(*xfp->pthis), TASK_D, xfp->n1, xfp->n2_2, 0, xfp->b, 0,
                xfp->a + xfp->n2_1 * xfp->nx, xfp->nx, xfp->anx);
      xfp->spawned2 = 1;
      make_and_send_task (xfp->_thr, 0, xfp->pthis);
      *((int *) efp) = 1;
      return 0;
...
void
decomp_d (char *esp, closure_t * _bk, struct thread_data *_thr, int n1,
          int n2, double *b, double *a, int nx, int anx)
{
  ...
  if (esp_flag)
    {
      ...
      esp =
        (char *) ((Align_t *) esp +
                  (sizeof (struct decomp_d_frame) + sizeof (Align_t) +
                   -1) / sizeof (Align_t));
      *((char **) esp) = 0;
    LGOTO:switch ((*efp).call_id)
        {
    ...
    n2_2 = n2 - n2_1;
    {
      ...
      spawned2 = 0;
      {
          ...
          }
        {
          new_esp = esp;
          while (decomp_d
                 (new_esp, &efp->do_two_bk2, _thr, n1, n2_1, b, a, nx, anx),
                 __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
            {
              efp->spawned2 = spawned2;
              efp->pthis = pthis;
      ...
      if (spawned2)
      ...
      else
        {
          new_esp = esp;
          while (decomp_d
                 (new_esp, _bk, _thr, n1, n2_2, b, a + n2_1 * nx, nx, anx),
                 __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
            {
              efp->spawned2 = spawned2;
              efp->pthis = pthis;
...
char *
do_two_bk3_in_decomp_rd (char *esp, void *xfp0)
{
  char *new_esp;
...
LGOTO:;
  ...
  esp =
    (char *) ((Align_t *) esp +
              (sizeof (struct do_two_bk3_in_decomp_rd_frame) +
               sizeof (Align_t) + -1) / sizeof (Align_t));
  *((char **) esp) = 0;
  if (xfp->spawned3)
    {
  ...
  if ((*xfp->_thr).treq_top)
    {
      put_task (&(*xfp->pthis), TASK_RD, xfp->n1, xfp->n2_2, xfp->n3,
                xfp->b1 + xfp->n2_1 * xfp->nx, xfp->b2,
                xfp->a + xfp->n2_1 * xfp->anx, xfp->nx, xfp->anx);
      xfp->spawned3 = 1;
      make_and_send_task (xfp->_thr, 0, xfp->pthis);
      *((int *) efp) = 1;
      return 0;
...
void
decomp_rd (char *esp, closure_t * _bk, struct thread_data *_thr, int n1,
           int n2, int n3, double *b1, double *b2, double *a, int nx, int anx)
{
  ...
  if (esp_flag)
    {
      ...
      esp =
        (char *) ((Align_t *) esp +
                  (sizeof (struct decomp_rd_frame) + sizeof (Align_t) +
                   -1) / sizeof (Align_t));
      *((char **) esp) = 0;
    LGOTO:switch ((*efp).call_id)
        {
  ...
  if (n1 > n2)
    {
      ...
      n1_2 = n1 - n1_1;
      new_esp = esp;
      while (decomp_rd (new_esp, _bk, _thr, n1_1, n2, n3, b1, b2, a, nx, anx),
             __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
        {
          efp->n1_2 = n1_2;
          efp->n1_1 = n1_1;
      ...
      new_esp = esp;
      while (decomp_rd
             (new_esp, _bk, _thr, n1_2, n2, n3, b1 + n1_1, b2 + n1_1 * nx, a,
              nx, anx), __builtin_expect ((efp->tmp_esp =
                                           *((char **) esp)) != 0, 0))
        {
          efp->n1_2 = n1_2;
          efp->n1_1 = n1_1;
      ...
      n2_2 = n2 - n2_1;
      {
        ...
        spawned3 = 0;
        {
          if ((*_thr).req)
            {
              new_esp = esp;
              while (handle_req (new_esp, &efp->do_two_bk3, _thr),
                     __builtin_expect ((efp->tmp_esp =
                                        *((char **) esp)) != 0, 0))
                {
            ...
            }
          {
            new_esp = esp;
            while (decomp_rd
                   (new_esp, &efp->do_two_bk3, _thr, n1, n2_1, n3, b1, b2, a,
                    nx, anx), __builtin_expect ((efp->tmp_esp =
                                                 *((char **) esp)) != 0, 0))
              {
                efp->spawned3 = spawned3;
        ...
        if (spawned3)
        ...
        else
          {
            new_esp = esp;
            while (decomp_rd
                   (new_esp, _bk, _thr, n1, n2_2, n3, b1 + n2_1 * nx, b2,
                    a + n2_1 * anx, nx, anx),
                   __builtin_expect ((efp->tmp_esp =
                                      *((char **) esp)) != 0, 0))
              {
...
void
decomp_lu_1 (char *esp, closure_t * _bk, struct thread_data *_thr, int n,
             double *a, int nx, int anx)
{
  ...
  if (esp_flag)
    {
      ...
      esp =
        (char *) ((Align_t *) esp +
                  (sizeof (struct decomp_lu_1_frame) + sizeof (Align_t) +
                   -1) / sizeof (Align_t));
      *((char **) esp) = 0;
    LGOTO:switch ((*efp).call_id)
        {
    ...
    for (; i < n; i += 16)
      {
        ...
        new_esp = esp;
        while (decomp_rd
               (new_esp, _bk, _thr, i, n1, n - i, a + i * nx, a + i,
                a + (i * nx + i), nx, anx), __builtin_expect ((efp->tmp_esp =
                                                               *((char **)
                                                                 esp)) != 0,
                                                              0))
          {
...
void
start_lu (char *esp, closure_t * _bk, struct thread_data *_thr, int n1,
          int n2, int n3, double *ansp)
{
  struct start_lu_frame *efp;
  char *new_esp;
  size_t esp_flag = (size_t) esp & 3;
  int n;
  int al;
  ...
  if (esp_flag)
    {
      esp = (char *) ((size_t) esp ^ esp_flag);
      efp = (struct start_lu_frame *) esp;
      esp =
        (char *) ((Align_t *) esp +
                  (sizeof (struct start_lu_frame) + sizeof (Align_t) +
                   -1) / sizeof (Align_t));
      *((char **) esp) = 0;
    LGOTO:switch ((*efp).call_id)
        {
  ...
  *((char **) esp) = 0;
  ...
  switch (al)
    ...
    case 2:
      new_esp = esp;
      while (decomp_lu (new_esp, _bk, _thr, n, a, nx, nx),
             __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
        {
          efp->c = c;
          efp->u = u;
    ...
    case 3:
      new_esp = esp;
      while (decomp_lu_1 (new_esp, _bk, _thr, n, a, nx, nx),
             __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
        {
          efp->c = c;
          efp->u = u;
...
char *
_bk_in_do_task_lu_task (char *esp, void *xfp0)
{
  char *new_esp;
...
LGOTO:;
  ...
  esp =
    (char *) ((Align_t *) esp +
              (sizeof (struct _bk_in_do_task_lu_task_frame) +
               sizeof (Align_t) + -1) / sizeof (Align_t));
  *((char **) esp) = 0;
  *((int *) efp) = 0;
  return 0;
...
void
do_task_lu_task (char *esp, struct thread_data *_thr, struct task_lu *pthis)
{
  ...
  if (esp_flag)
    {
      ...
      esp =
        (char *) ((Align_t *) esp +
                  (sizeof (struct do_task_lu_task_frame) + sizeof (Align_t) +
                   -1) / sizeof (Align_t));
      *((char **) esp) = 0;
    LGOTO:switch ((*efp).call_id)
        {
  ...
  *((char **) esp) = 0;
    ...
    }
  {
    ...
    switch ((*pthis).tt)
      ...
      case TASK_CMD:
        new_esp = esp;
        while (start_lu (new_esp, &efp->_bk, _thr, n1, n2, n3, a),
               __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
          {
            efp->anx = anx;
            efp->nx = nx;
      ...
      case TASK_LU:
        new_esp = esp;
        while (decomp_lu (new_esp, &efp->_bk, _thr, n1, a, nx, anx),
               __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
          {
            efp->anx = anx;
            efp->nx = nx;
      ...
      case TASK_R:
        new_esp = esp;
        while (decomp_r (new_esp, &efp->_bk, _thr, n1, n2, b1, a, nx, anx),
               __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
          {
            efp->anx = anx;
            efp->nx = nx;
      ...
      case TASK_D:
        new_esp = esp;
        while (decomp_d (new_esp, &efp->_bk, _thr, n1, n2, b1, a, nx, anx),
               __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
          {
            efp->anx = anx;
            efp->nx = nx;
      ...
      case TASK_RD:
        new_esp = esp;
        while (decomp_rd
               (new_esp, &efp->_bk, _thr, n1, n2, n3, b1, b2, a, nx, anx),
               __builtin_expect ((efp->tmp_esp = *((char **) esp)) != 0, 0))
          {
            efp->anx = anx;
            efp->nx = nx;
...
void
send_task_lu_task (struct task_lu *pthis)
{
  int n1 = (*pthis).n1;
  int n2 = (*pthis).n2;
  int n3 = (*pthis).n3;
...
void
send_task_lu_rslt (struct task_lu *pthis)
{
  int n1 = (*pthis).n1;
  int n2 = (*pthis).n2;
  int n3 = (*pthis).n3;
...
void
recv_task_lu_rslt (struct task_lu *pthis)
{
  int n1 = (*pthis).n1;
  int n2 = (*pthis).n2;
  int n3 = (*pthis).n3;
