...
LGOTO:switch ((*efp).call_id) {
  ...
  *((char **)esp) = 0;
  ...
  if (0 > (*pthis).n2) {
    ...
    {
      new_esp = esp;
      while (__builtin_expect((tmp = cmp_1(new_esp, &efp->_bk, _thr, (*pthis).n1, (*pthis).n2, (*pthis).d1, (*pthis).d2)) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
        efp->tmp = tmp;
        efp->j = j;
        efp->i = i;
        efp->pthis = pthis;
    ...
    new_esp = esp;
    while (__builtin_expect((tmp2 = cmp_1(new_esp, &efp->_bk, _thr, (*pthis).n1, (*pthis).n2, (*pthis).d1, (*pthis).d2)) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
      efp->tmp2 = tmp2;
      efp->tmp = tmp;
      efp->j = j;
      efp->i = i;
...
LGOTO:;
  ...
  esp = (char *)((Align_t *) esp + (sizeof(struct do_two_bk_in_cmp_1_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  if (xfp->spawned) {
    *((int *)efp) = 0;
    return 0;
...
LGOTO:;
  ...
  esp = (char *)((Align_t *) esp + (sizeof(struct do_two_bk2_in_cmp_1_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  if (xfp->spawned2) {
    *((int *)efp) = 0;
    return 0;
  ...
  if (n1 > n2) {
    ...
    n1_2 = n1 - n1_1;
    {
      ...
      spawned = 0;
      {
        if ((*_thr).req) {
          new_esp = esp;
          while (handle_req(new_esp, &efp->do_two_bk, _thr), __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 0)) {
            efp->spawned = spawned;
            efp->pthis = pthis;
            efp->n1_2 = n1_2;
            efp->n1_1 = n1_1;
        ...
        L_CALL3:;
          ...
          new_esp = esp;
          while (__builtin_expect((s1 = cmp_1(new_esp, &efp->do_two_bk, _thr, n1_1, n2, d1, d2)) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
            efp->spawned = spawned;
            efp->pthis = pthis;
            efp->n1_2 = n1_2;
            efp->n1_1 = n1_1;
      ...
      if (spawned) {
        new_esp = esp;
        while (wait_rslt(new_esp, _thr), __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 0)) {
          efp->spawned = spawned;
          efp->pthis = pthis;
          efp->n1_2 = n1_2;
          efp->n1_1 = n1_1;
      ...
      L_CALL5:;
        ...
        new_esp = esp;
        while (__builtin_expect((s2 = cmp_1(new_esp, _bk, _thr, n1_2, n2, d1 + n1_1, d2)) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
          efp->spawned = spawned;
          efp->pthis = pthis;
          efp->n1_2 = n1_2;
          efp->n1_1 = n1_1;
    ...
    n2_2 = n2 - n2_1;
    {
      ...
      spawned2 = 0;
      {
        if ((*_thr).req) {
          new_esp = esp;
          while (handle_req(new_esp, &efp->do_two_bk2, _thr), __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 0)) {
        ...
        L_CALL7:;
          ...
          new_esp = esp;
          while (__builtin_expect((s1 = cmp_1(new_esp, &efp->do_two_bk2, _thr, n1, n2_1, d1, d2)) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
            efp->spawned2 = spawned2;
            efp->pthis2 = pthis2;
            efp->n2_2 = n2_2;
            efp->n2_1 = n2_1;
      ...
      L_CALL9:;
        ...
        new_esp = esp;
        while (__builtin_expect((s2 = cmp_1(new_esp, _bk, _thr, n1, n2_2, d1, d2 + n2_1)) == (int)0 - 1, 0) && __builtin_expect((efp->tmp_esp = *((char **)esp)) != 0, 1)) {
          efp->spawned2 = spawned2;
          efp->pthis2 = pthis2;
          efp->n2_2 = n2_2;
          efp->n2_1 = n2_1;
