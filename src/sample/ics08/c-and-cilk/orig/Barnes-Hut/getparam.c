...
static const char *ident __attribute__((__unused__))
     = "$HeadURL: https://bradley.csail.mit.edu/svn/repos/cilk/5.4.3/examples/Barnes-Hut/getparam.c $ $LastChangedBy: bradley $ $Rev: 79 $ $Date: 2002-12-26 01:43:37 -0500 (Thu, 26 Dec 2002) $";
