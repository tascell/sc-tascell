...
void
send_start_pentomino_task (struct thread_data *_thr,
			   struct start_pentomino *pthis)
{
}

struct start_pentomino *
recv_start_pentomino_task (struct thread_data *_thr)
{
...
void
send_start_pentomino_rslt (struct thread_data *_thr,
			   struct start_pentomino *pthis)
{
  send_int ((*pthis).r);
  free (pthis);
...
void
recv_start_pentomino_rslt (struct thread_data *_thr,
			   struct start_pentomino *pthis)
{
  (*pthis).r = recv_int ();
}
...
void
send_pentomino_task (struct thread_data *_thr, struct pentomino *pthis)
{
  send_int ((*pthis).k);
  send_int ((*pthis).i0);
  send_int ((*pthis).i1);
...
struct pentomino *
recv_pentomino_task (struct thread_data *_thr)
{
...
void
send_pentomino_rslt (struct thread_data *_thr, struct pentomino *pthis)
{
  send_int ((*pthis).r);
  free (pthis);
}
...
void
recv_pentomino_rslt (struct thread_data *_thr, struct pentomino *pthis)
{
  (*pthis).r = recv_int ();
}
