  ...
  *((char **)esp) = 0;
  if (n <= 4) {
	...
	L_CALL:
	  ...
	  new_esp = esp;
	  while (decomp_r(new_esp, &efp->_bk2, _thr, n1, n2, a, a + n1, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk0 = _bk0;
	    efp->spawned = spawned;
	    efp->pthis = pthis;
	    efp->n2 = n2;
	...
	L_CALL3:
	  ...
	  new_esp = esp;
	  while (decomp_d(new_esp, &efp->_bk2, _thr, n1, n2, a, a + n1 * nx, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk0 = _bk0;
	    efp->spawned = spawned;
	    efp->pthis = pthis;
	    efp->n2 = n2;
    ...
    new_esp = esp;
    while (decomp_rd(new_esp, _bk, _thr, n1, n2, n2, a + n1 * nx, a + n1, a + (n1 * nx + n1), nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->_bk0 = _bk0;
      efp->spawned = spawned;
      efp->pthis = pthis;
      efp->n2 = n2;
  ...
  L_CALL5:
    ...
    new_esp = esp;
    while (decomp_lu(new_esp, _bk, _thr, n2, a + (n1 * nx + n1), nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->_bk0 = _bk0;
      efp->spawned = spawned;
      efp->pthis = pthis;
      efp->n2 = n2;
...
LGOTO:
  ...
  *((char **)esp) = 0;
  if (n1 <= 4) {
    ...
    n1_2 = n1 - n1_1;
    new_esp = esp;
    while (decomp_r(new_esp, _bk, _thr, n1_1, n2, b, a, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->n1_2 = n1_2;
      efp->n1_1 = n1_1;
      efp->anx = anx;
      efp->nx = nx;
  ...
  L_CALL7:
    ...
    new_esp = esp;
    while (decomp_rd(new_esp, _bk, _thr, n1_1, n1_2, n2, b + n1_1 * nx, a, a + n1_1 * nx, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->n1_2 = n1_2;
      efp->n1_1 = n1_1;
      efp->anx = anx;
      efp->nx = nx;
  ...
  L_CALL8:
    ...
    new_esp = esp;
    while (decomp_r(new_esp, _bk, _thr, n1_2, n2, b + (n1_1 * nx + n1_1), a + n1_1 * nx, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->n1_2 = n1_2;
      efp->n1_1 = n1_1;
      efp->anx = anx;
      efp->nx = nx;
  ...
  *((char **)esp) = 0;
  if (n2 <= 4) {
	...
	L_CALL10:
	  ...
	  new_esp = esp;
	  while (decomp_d(new_esp, &efp->_bk3, _thr, n1, n2_1, b, a, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk0 = _bk0;
	    efp->spawned2 = spawned2;
	    efp->pthis = pthis;
	    efp->n2_2 = n2_2;
	...
	L_CALL12:
	  ...
	  new_esp = esp;
	  while (decomp_d(new_esp, &efp->_bk3, _thr, n1, n2_2, b, a + n2_1 * nx, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk0 = _bk0;
	    efp->spawned2 = spawned2;
	    efp->pthis = pthis;
	    efp->n2_2 = n2_2;
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  if (n1 > n2) {
	...
	if ((*_thr).req) {
	  new_esp = esp;
	  while (handle_req(new_esp, &efp->_bk4, _thr), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk0 = _bk0;
	...
	L_CALL14:
	  ...
	  new_esp = esp;
	  while (decomp_rd(new_esp, &efp->_bk4, _thr, n1_1, n2, n3, b1, b2, a, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk0 = _bk0;
	    efp->spawned3 = spawned3;
	    efp->pthis = pthis;
	    efp->n1_2 = n1_2;
	...
	L_CALL16:
	  ...
	  merge_task(&(*pthis), a, anx);
	} else {
	  new_esp = esp;
	  while (decomp_rd(new_esp, &efp->_bk4, _thr, n1_2, n2, n3, b1 + n1_1, b2 + n1_1 * nx, a, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk0 = _bk0;
	    efp->spawned3 = spawned3;
	    efp->pthis = pthis;
	    efp->n1_2 = n1_2;
	...
	if ((*_thr).req) {
	  new_esp = esp;
	  while (handle_req(new_esp, &efp->_bk5, _thr), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk02 = _bk02;
	...
	L_CALL18:
	  ...
	  new_esp = esp;
	  while (decomp_rd(new_esp, &efp->_bk5, _thr, n1, n2_1, n3, b1, b2, a, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk02 = _bk02;
	    efp->spawned4 = spawned4;
	    efp->pthis2 = pthis2;
	    efp->n2_2 = n2_2;
	...
	L_CALL20:
	  ...
	  merge_task(&(*pthis2), a + n2_1 * anx, anx);
	} else {
	  new_esp = esp;
	  while (decomp_rd(new_esp, &efp->_bk5, _thr, n1, n2_2, n3, b1 + n2_1 * nx, b2, a + n2_1 * anx, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    efp->_bk02 = _bk02;
	    efp->spawned4 = spawned4;
	    efp->pthis2 = pthis2;
	    efp->n2_2 = n2_2;
  ...
  *((char **)esp) = 0;
  {
	...
	n1 = n - i;
      ...
      new_esp = esp;
      while (decomp_rd(new_esp, _bk, _thr, i, n1, n - i, a + i * nx, a + i, a + (i * nx + i), nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	efp->n1 = n1;
	efp->i = i;
	efp->anx = anx;
	efp->nx = nx;
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  case 2:
    new_esp = esp;
    while (decomp_lu(new_esp, _bk, _thr, n, a, nx, nx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->c = c;
      efp->u = u;
      efp->l = l;
      efp->a = a;
  ...
  case 3:
    new_esp = esp;
    while (decomp_lu_1(new_esp, _bk, _thr, n, a, nx, nx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->c = c;
      efp->u = u;
      efp->l = l;
      efp->a = a;
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  a = (*pthis).a;
  nx = (*pthis).nx;
  anx = (*pthis).tmpnx ? (*pthis).tmpnx : (*pthis).anx;
  fprintf(stderr, "start %d\n", (*pthis).tt);
  switch ((*pthis).tt) {
  case TASK_CMD:
    new_esp = esp;
    while (proc_cmd(new_esp, &efp->_bk, _thr, n1, n2, n3, a), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->anx = anx;
      efp->nx = nx;
      efp->a = a;
      efp->b2 = b2;
  ...
  case TASK_LU:
    new_esp = esp;
    while (decomp_lu(new_esp, &efp->_bk, _thr, n1, a, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->anx = anx;
      efp->nx = nx;
      efp->a = a;
      efp->b2 = b2;
  ...
  case TASK_R:
    new_esp = esp;
    while (decomp_r(new_esp, &efp->_bk, _thr, n1, n2, b1, a, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->anx = anx;
      efp->nx = nx;
      efp->a = a;
      efp->b2 = b2;
  ...
  case TASK_D:
    new_esp = esp;
    while (decomp_d(new_esp, &efp->_bk, _thr, n1, n2, b1, a, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->anx = anx;
      efp->nx = nx;
      efp->a = a;
      efp->b2 = b2;
  ...
  case TASK_RD:
    new_esp = esp;
    while (decomp_rd(new_esp, &efp->_bk, _thr, n1, n2, n3, b1, b2, a, nx, anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      efp->anx = anx;
      efp->nx = nx;
      efp->a = a;
      efp->b2 = b2;
