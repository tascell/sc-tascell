...
size_t Alist_node[] =
    { (unsigned int) &(*((Alist *) 0)).kv,
(unsigned int) &(*((Alist *) 0)).cdr };
descriptor Alist_d =
    { sizeof (Alist),
sizeof (align_t) * ((sizeof (Alist) + sizeof (align_t) - 1) / sizeof (align_t)),
sizeof (Alist_node) / sizeof (size_t), Alist_node };
size_t KVpair_node[] = { };
descriptor KVpair_d =
    { sizeof (KVpair),
sizeof (align_t) * ((sizeof (KVpair) + sizeof (align_t) - 1) / sizeof (align_t)),
sizeof (KVpair_node) / sizeof (size_t), KVpair_node };
static int maxins;
...
lgoto:
  ...
  esp =
      (char *) ((Align_t *) esp +
		(sizeof (struct scan1_in_bin2list_frame) + sizeof (Align_t) +
		 -1) / sizeof (Align_t));
  *((char **) esp) = 0;
  efp->xfp = xfp;
  xfp->x = move (xfp->x);
...
lgoto:
  ...
  esp =
      (char *) ((Align_t *) esp +
		(sizeof (struct bin2list_frame) + sizeof (Align_t) +
		 -1) / sizeof (Align_t));
  *((char **) esp) = 0;
  efp->scan0 = scan0;
  efp->x = x;
  ...
  if ((*efp->x).right)
    {
      ...
      while ((efp->rest =
	      bin2list (esp, &efp->scan1, tmp_arg2,
			efp->rest)) == (struct _Alist *) 0 - 1
	     && (efp->tmp_esp = *((char **) esp)) != 0)
	{
	  if ((char *) efp->tmp_esp < (char *) efp)
	    return (Alist *) 0 - 1;
  ...
  tmp_arg3 = &KVpair_d;
  while ((efp->kv = getmem (esp, &efp->scan1, tmp_arg3)) == (void *) 0 - 1
	 && (efp->tmp_esp = *((char **) esp)) != 0)
    {
      if ((char *) efp->tmp_esp < (char *) efp)
	return (Alist *) 0 - 1;
  ...
  (*efp->kv).key = (*efp->x).key;
  (*efp->kv).val = (*efp->x).val;
  tmp_arg4 = &Alist_d;
  while ((efp->a = getmem (esp, &efp->scan1, tmp_arg4)) == (void *) 0 - 1
	 && (efp->tmp_esp = *((char **) esp)) != 0)
    {
      if ((char *) efp->tmp_esp < (char *) efp)
	return (Alist *) 0 - 1;
  ...
  if ((*efp->x).left)
    {
      tmp_arg5 = (*efp->x).left;
      while ((efp->rest =
	      bin2list (esp, &efp->scan1, tmp_arg5,
			efp->rest)) == (struct _Alist *) 0 - 1
	     && (efp->tmp_esp = *((char **) esp)) != 0)
	{
	  if ((char *) efp->tmp_esp < (char *) efp)
...
lgoto:
  ...
  *((char **) esp) = 0;
  ...
  init (efp->gctp < 0 ? 0 : efp->gctp, efp->ifexp_result7, efp->ifexp_result8,
	efp->ifexp_result9);
  tmp_arg6 = &Bintree_d;
  while ((efp->root = getmem (esp, &efp->scan1, tmp_arg6)) == (void *) 0 - 1
	 && (efp->tmp_esp = *((char **) esp)) != 0)
    {
      if ((char *) efp->tmp_esp < (char *) efp)
	return (int) 0 - 1;
  ...
  if (!efp->searchskip)
    while (bin2list (esp, &efp->scan1, efp->root, 0),
	   (efp->tmp_esp = *((char **) esp)) != 0)
      {
	if ((char *) efp->tmp_esp < (char *) efp)
	  return (int) 0 - 1;
