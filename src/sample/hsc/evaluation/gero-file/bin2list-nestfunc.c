...
lgoto:
  ...
  *((char **)esp) = 0;
  ...
  new_esp = esp;
  tmp_arg3 = &_KVpair_d;
  while ((tmp6 = getmem(new_esp, &efp->scan1, tmp_arg3)) == (void *)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0) {
    efp->tmp7 = tmp7;
    efp->tmp6 = tmp6;
    efp->kv = kv;
    efp->a = a;
...
L_CALL8:
  ...
  tmp_object2 = (struct _KVpair *) tmp6;
  (*tmp_object2).key = (*x).key;
  (*tmp_object2).val = (*x).val;
  kv = tmp_object2;
  new_esp = esp;
  tmp_arg4 = &_Alist_d;
  while ((tmp7 = getmem(new_esp, &efp->scan1, tmp_arg4)) == (void *)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0) {
    efp->tmp7 = tmp7;
    efp->tmp6 = tmp6;
    efp->kv = kv;
    efp->a = a;
...
L_CALL9:
  ...
  tmp_object3 = (struct _Alist *) tmp7;
  (*tmp_object3).kv = kv;
  (*tmp_object3).cdr = rest;
  a = tmp_object3;
  rest = a;
  if ((*x).left) {
    new_esp = esp;
...
lgoto:
  ...
  *((char **)esp) = 0;
  ...
  if (argc > 1) {
    tmp12 = strcmp(argv[1], "-s");
    ifexp_result7 = tmp12 == 0 ? 1 : 0;
  } else {
    ifexp_result7 = 0;
  }
  if (ifexp_result7) {
  ...
  new_esp = esp;
  tmp_arg6 = &_Bintree_d;
  while ((tmp15 = getmem(new_esp, &efp->scan1, tmp_arg6)) == (void *)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0) {
    char           *goto_fr;
    *((char **)esp) = 0;
    efp->tmp15 = tmp15;
    ...
    i = efp->i;
    tmp_object4 = efp->tmp_object4;
    argv = efp->argv;
    argc = efp->argc;
    tmp_arg6 = efp->tmp_arg6;
    new_esp = esp + 1;
  }
  tmp_object4 = (struct _Bintree *) tmp15;
  (*tmp_object4).key = 0;
  (*tmp_object4).val = 0;
  (*tmp_object4).left = 0;
  (*tmp_object4).right = 0;
