...
"Bintree-Tascell_gcc_cas.dat"   using 1:2 title "Tascell_gcc_cas"      with linespoints lt 3 pt 6,\
"Bintree-Tascell_gcc_membar.dat"   using 1:2 title "Tasell_gcc_membar"      with linespoints lt 3 pt 2
