...
plot \
"Bintree-Cilk_cas.dat"  using 1:2 title "Cilk_cas"     with linespoints,\
"Bintree-Cilk_membar.dat"  using 1:2 title "Cilk_membar"     with linespoints,\
"Bintree-Tascell_cas.dat"  using 1:2 title "Tascell_cas"     with linespoints,\
"Bintree-Tascell_membar.dat"  using 1:2 title "Tascell_membar"     with linespoints,\
"Bintree-Tascell_gcc_cas.dat"   using 1:2 title "Tascell_gcc_cas"      with linespoints,\
"Bintree-Tascell_gcc_membar.dat"   using 1:2 title "Tasell_gcc_membar"      with linespoints
