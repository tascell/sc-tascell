...
"Hypercube20-Cilk_R_cas.dat"  using 1:2 title "Cilk_R_cas"     with linespoints lt 3 pt 6,\
"Hypercube20-Cilk_R_membar.dat"  using 1:2 title "Cilk_R_membar"     with linespoints lt 3 pt 2,\
...
# "Hypercube20-serial_call_membar.dat" using 1:2 title "serial_call_membar" with linespoints,\
