...
void grav_x (int (*_bk) closure (void), struct thread_data *_thr, int minx,
...
void grav_z (int (*_bk) closure (void), struct thread_data *_thr, int x, int y,
...
void grav_y (int (*_bk) closure (void), struct thread_data *_thr, int x,
