...
void decomp_lu (int (*_bk) closure (void), struct thread_data *_thr, int n,
                double *a, int nx, int anx);

void decomp_r (int (*_bk) closure (void), struct thread_data *_thr, int n1,
               int n2, double *b, double *a, int nx, int an);

void decomp_d (int (*_bk) closure (void), struct thread_data *_thr, int n1,
               int n2, double *b, double *a, int nx, int an);

void decomp_rd (int (*_bk) closure (void), struct thread_data *_thr, int n1,
...
void decomp_lu_1 (int (*_bk) closure (void), struct thread_data *_thr, int n,
                  double *a, int nx, int anx)
{
  int i;
...
void start_lu (int (*_bk) closure (void), struct thread_data *_thr, int n1,
