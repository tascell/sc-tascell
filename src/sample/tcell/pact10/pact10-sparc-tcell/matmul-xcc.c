...
void matmul_1 (int (*_bk) lightweight (void), struct thread_data *_thr, int,
               int, int, int, int, double *, double *, double *, int,
               struct tmatmul *);

void matmul_2 (int, int, int, int, int, int, double *, double *, double *, int);

void flush_subtask_queue (int (*_bk) lightweight (void),
                          struct thread_data *_thr, int, double *, double *,
                          double *, int, struct tmatmul *);
...
void matmul_s (int (*_bk) lightweight (void), struct thread_data *_thr, int i0,
...
void flush_subtask_queue (int (*_bk) lightweight (void),
                          struct thread_data *_thr, int n, double *a, double *b,
                          double *c, int nx, struct tmatmul *tsk)
{
  int m;
  int head = (*tsk).head;
  struct mm_subtask *sq = (*tsk).queue;
...
void matmul_1 (int (*_bk) lightweight (void), struct thread_data *_thr, int i0,
               int i1, int j0, int j1, int n, double *a, double *b, double *c,
               int nx, struct tmatmul *tsk)
{
  {
