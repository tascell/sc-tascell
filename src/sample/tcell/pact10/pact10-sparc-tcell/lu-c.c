...
void decomp_r (int n1, int n2, double *b, double *a, int nx, int anx)
{
  if (n1 <= 4)
    {
...
void decomp_d (int n1, int n2, double *b, double *a, int nx, int anx)
{
  if (n2 <= 4)
    {
  ...
  if (n1 > n2)
  ...
  else
    {
...

      {
        ...
        {
          decomp_rd (n1, n2_2, n3, b1 + n2_1 * nx, b2, a + n2_1 * anx, nx, anx);
        }
      }
    }
}

void decomp_lu_1 (int n, double *a, int nx, int anx)
{
  int i;
    ...
    for (; i < n; i += 16)
      {
        ...
        decomp_rd (i, n1, n - i, a + i * nx, a + i, a + (i * nx + i), nx, anx);
...
void start_lu (int n1, int n2, int n3, double *ansp)
{
  struct timeval tp[2];
  int n = n1;
  int al = n2;
