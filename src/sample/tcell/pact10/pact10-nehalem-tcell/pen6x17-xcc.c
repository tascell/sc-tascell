...
int search (int (*_bk) lightweight (void), struct thread_data *_thr, int k,
            int j0, int j1, int j2, int maxp, int maxk, struct pentomino *tsk);
...
int ps[73][5] =
  ...
  {7, 7, 7, 7} };
int pos[21] =
  { 0, 2, 4, 12, 16, 20, 24, 32, 36, 37, 45, 53, 57, 59, 61, 63, 65, 67, 69, 71,
73 };
              ...
              }
              {
                ...
                }
                {
                  ...
                  }
                  {
                    ...
                    if (kk == maxk)
                      s += 1;
                    else if ((kk + 7 >= maxk || ((*tsk).b)[kk + 7] != 0)
                             && (((*tsk).b)[kk + 1] != 0
                                 || (kk + 8 >= maxk || ((*tsk).b)[kk + 8] != 0)
                                 && ((*tsk).b)[kk + 2] != 0))
                      ;
                    else
                      s +=
                        search (dwind_bk, _thr, kk, j0 + 1, j0 + 1, maxp, maxp,
                                maxk, tsk);
                  }
                  {
                    ap = ((*tsk).a)[j0];
