...
void search1_p (int (*_bk) (void), struct thread_data *_thr, int v, int b,
                int k0, int k1);

void search_p_b (int (*_bk) (void), struct thread_data *_thr,
                 struct v_list_body *my_v_list, int i0, int i1);

void search_p_b_array (int (*_bk) (void), struct thread_data *_thr,
                       struct v_list_body **my_v_array, int i0, int i1);

void search_p_c (int (*_bk) (void), struct thread_data *_thr,
...
void search_p (int (*_bk) (void), struct thread_data *_thr, int v)
{
...
void search_p_array (int (*_bk) (void), struct thread_data *_thr, int v)
{
