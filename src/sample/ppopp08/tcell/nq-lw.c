...
LGOTO:;
  ...
  esp = (char *)((Align_t *) esp + (sizeof(struct do_many_bk_in_nqueens_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  if (!xfp->spawned) {
    char           *goto_fr;
...
LGOTO:;
  ...
  esp = (char *)((Align_t *) esp + (sizeof(struct dwind_bk_in_nqueens_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  {
...
int		nqueens    (char *esp, closure_t * _bk, struct thread_data *_thr, int n, int k, int ix, int iy, struct nqueens *tsk)
{
  ...
  if (esp_flag) {
    ...
    esp = (char *)((Align_t *) esp + (sizeof(struct nqueens_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
    *((char **)esp) = 0;
LGOTO:switch ((*efp).call_id) {
  ...
  *((char **)esp) = 0;
  s = 0;
  {
    ...
    if ((*_thr).req) {
      new_esp = esp;
      while (__builtin_expect((handle_req(new_esp, &efp->do_many_bk, _thr), (efp->tmp_esp = *((char **)esp)) != 0),0)) {
	efp->spawned = spawned;
	efp->pthis = pthis;
	efp->i_end = i_end;
	efp->i = i;
	...
	if (!ifexp_result5)
	  if (k == n - 1) {
	    ...
	    }
	    {
	      {
		new_esp = esp;
		while (__builtin_expect(((tmp = nqueens(new_esp, &efp->dwind_bk, _thr, n, k + 1, k + 1, n, tsk)) == (int)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
		  efp->tmp = tmp;
		  efp->ai = ai;
    ...
    while (spawned-- > 0) {
      {
	new_esp = esp;
	while (__builtin_expect(((tmp2 = wait_rslt(new_esp, _thr)) == (void *)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
	  efp->tmp2 = tmp2;
	  efp->tmp = tmp;
	  efp->ai = ai;
	  efp->ifexp_result5 = ifexp_result5;
...
LGOTO:;
  ...
  esp = (char *)((Align_t *) esp + (sizeof(struct _bk_in_do_nqueens_task_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  *((int *)efp) = 0;
  return 0;
  return 0;
...
void		do_nqueens_task(char *esp, struct thread_data *_thr, struct nqueens *pthis)
{
  ...
  if (esp_flag) {
    ...
    esp = (char *)((Align_t *) esp + (sizeof(struct do_nqueens_task_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
    *((char **)esp) = 0;
LGOTO:switch ((*efp).call_id) {
    case 0:
      goto L_CALL4;
 ...
 // fprintf(stderr, "start %d %d %d %d\n", n, k, (*pthis).i1, (*pthis).i2);
  if (k < 0) {
    ...
    {
      new_esp = esp;
      while (__builtin_expect(((tmp3 = nqueens(new_esp, &efp->_bk, _thr, n, 0, 0, n, &(*pthis))) == (int)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
	efp->tmp3 = tmp3;
	efp->k = k;
	efp->n = n;
	efp->i = i;
    ...
    new_esp = esp;
    while (__builtin_expect(((tmp4 = nqueens(new_esp, &efp->_bk, _thr, n, k, (*pthis).i1, (*pthis).i2, &(*pthis))) == (int)0 - 1 && (efp->tmp_esp = *((char **)esp)) != 0),0)) {
      efp->tmp4 = tmp4;
      efp->tmp3 = tmp3;
      efp->k = k;
      efp->n = n;
