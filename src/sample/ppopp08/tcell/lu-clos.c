...
struct _bk2_in_decomp_lu_frame {
  char           *tmp_esp;
  char           *argp;
  int		  call_id;
...
char           *_bk2_in_decomp_lu(char *esp, void *xfp0)
{
  struct _bk2_in_decomp_lu_frame *efp;
...
LGOTO:
  ;
  efp = (struct _bk2_in_decomp_lu_frame *)esp;
  esp = (char *)((Align_t *) esp + (sizeof(struct _bk2_in_decomp_lu_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  efp->xfp = xfp;
  if (xfp->spawned) {
    *((int *)efp) = 0;
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  efp->nx = nx;
  efp->anx = anx;
  efp->_bk2.fun = _bk2_in_decomp_lu;
  efp->_bk2.fr = (void *)efp;
  if (efp->n <= 4) {
    decomp_lu_0(efp->n, efp->a, efp->nx, efp->anx);
    return;
  } {
    efp->n1 = efp->n > 16 ? efp->n / 4 : efp->n / 2;
    efp->n2 = efp->n - efp->n1;
    {
      efp->pthis = &efp->st2;
      efp->spawned = 0;
	...
	while (decomp_r(esp, &efp->_bk2, efp->_thr, efp->n1, efp->n2, efp->a, efp->a + efp->n1, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	  if ((char *)efp->tmp_esp < (char *)efp)
	    return;
	  efp->tmp_esp = 0;
	  goto LGOTO;
	...
	if (efp->spawned)
	  ...
	  while (decomp_d(esp, &efp->_bk2, efp->_thr, efp->n1, efp->n2, efp->a, efp->a + efp->n1 * efp->nx, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    if ((char *)efp->tmp_esp < (char *)efp)
	      return;
	    efp->tmp_esp = 0;
	    goto LGOTO;
    ...
    while (decomp_rd(esp, efp->_bk, efp->_thr, efp->n1, efp->n2, efp->n2, efp->a + efp->n1 * efp->nx, efp->a + efp->n1, efp->a + (efp->n1 * efp->nx + efp->n1), efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
    }
    while (decomp_lu(esp, efp->_bk, efp->_thr, efp->n2, efp->a + (efp->n1 * efp->nx + efp->n1), efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  efp->anx = anx;
  if (efp->n1 <= 4) {
    decomp_r_0(efp->n1, efp->n2, efp->b, efp->a, efp->nx, efp->anx);
    return;
  } {
    efp->n1_1 = efp->n1 / 2;
    efp->n1_2 = efp->n1 - efp->n1_1;
    while (decomp_r(esp, efp->_bk, efp->_thr, efp->n1_1, efp->n2, efp->b, efp->a, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
    }
    while (decomp_rd(esp, efp->_bk, efp->_thr, efp->n1_1, efp->n1_2, efp->n2, efp->b + efp->n1_1 * efp->nx, efp->a, efp->a + efp->n1_1 * efp->nx, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
    }
    while (decomp_r(esp, efp->_bk, efp->_thr, efp->n1_2, efp->n2, efp->b + (efp->n1_1 * efp->nx + efp->n1_1), efp->a + efp->n1_1 * efp->nx, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
...
char           *_bk3_in_decomp_d(char *esp, void *xfp0)
{
  struct _bk3_in_decomp_d_frame *efp;
...
LGOTO:
  ;
  efp = (struct _bk3_in_decomp_d_frame *)esp;
  esp = (char *)((Align_t *) esp + (sizeof(struct _bk3_in_decomp_d_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  efp->xfp = xfp;
  if (xfp->spawned2) {
    *((int *)efp) = 0;
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  efp->nx = nx;
  efp->anx = anx;
  efp->_bk3.fun = _bk3_in_decomp_d;
  efp->_bk3.fr = (void *)efp;
  if (efp->n2 <= 4) {
    decomp_d_0(efp->n1, efp->n2, efp->b, efp->a, efp->nx, efp->anx);
    return;
  } {
    efp->n2_1 = efp->n2 / 2;
	...
	while (decomp_d(esp, &efp->_bk3, efp->_thr, efp->n1, efp->n2_1, efp->b, efp->a, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	  if ((char *)efp->tmp_esp < (char *)efp)
	    return;
	  efp->tmp_esp = 0;
	  goto LGOTO;
	...
	if (efp->spawned2)
	  ...
	  while (decomp_d(esp, &efp->_bk3, efp->_thr, efp->n1, efp->n2_2, efp->b, efp->a + efp->n2_1 * efp->nx, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    if ((char *)efp->tmp_esp < (char *)efp)
	      return;
	    efp->tmp_esp = 0;
	    goto LGOTO;
...
struct _bk4_in_decomp_rd_frame {
  char           *tmp_esp;
  char           *argp;
  int		  call_id;
...
char           *_bk4_in_decomp_rd(char *esp, void *xfp0)
{
  struct _bk4_in_decomp_rd_frame *efp;
...
LGOTO:
  ;
  efp = (struct _bk4_in_decomp_rd_frame *)esp;
  esp = (char *)((Align_t *) esp + (sizeof(struct _bk4_in_decomp_rd_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  efp->xfp = xfp;
  if (xfp->spawned3) {
    *((int *)efp) = 0;
  ...
  if ((*xfp->_thr).treq_top) {
    put_task(&(*xfp->pthis), TASK_RD, xfp->n1_2, xfp->n2, xfp->n3, xfp->b1 + xfp->n1_1, xfp->b2 + xfp->n1_1 * xfp->nx, 0, xfp->nx, xfp->anx);
    xfp->spawned3 = 1;
    make_and_send_task(xfp->_thr, 0, xfp->pthis);
    *((int *)efp) = 1;
    return 0;
...
struct _bk5_in_decomp_rd_frame {
  char           *tmp_esp;
  char           *argp;
  int		  call_id;
  struct decomp_rd_frame *xfp;
...
char           *_bk5_in_decomp_rd(char *esp, void *xfp0)
{
  struct _bk5_in_decomp_rd_frame *efp;
  struct decomp_rd_frame *xfp = xfp0;
  char           *parmp = (char *)esp;
  char           *argp;
...
LGOTO:
  ;
  efp = (struct _bk5_in_decomp_rd_frame *)esp;
  esp = (char *)((Align_t *) esp + (sizeof(struct _bk5_in_decomp_rd_frame) + sizeof(Align_t) + -1) / sizeof(Align_t));
  *((char **)esp) = 0;
  efp->xfp = xfp;
  if (xfp->spawned4) {
    *((int *)efp) = 0;
  ...
  if ((*xfp->_thr).treq_top) {
    put_task(&(*xfp->pthis2), TASK_RD, xfp->n1, xfp->n2_2, xfp->n3, xfp->b1 + xfp->n2_1 * xfp->nx, xfp->b2, xfp->a + xfp->n2_1 * xfp->anx, xfp->nx, xfp->anx);
    xfp->spawned4 = 1;
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  efp->nx = nx;
  efp->anx = anx;
  efp->_bk5.fun = _bk5_in_decomp_rd;
  efp->_bk5.fr = (void *)efp;
  efp->_bk4.fun = _bk4_in_decomp_rd;
  efp->_bk4.fr = (void *)efp;
  if (efp->n1 <= 4 ? (efp->n2 <= 4 ? 1 : 0) : 0) {
    decomp_rd_0(efp->n1, efp->n2, efp->n3, efp->b1, efp->b2, efp->a, efp->nx, efp->anx);
    return;
  }
  if (efp->n1 > efp->n2) {
    efp->n1_1 = efp->n1 / 2;
	...
	efp->_bk0 = efp->_bk;
	if ((*efp->_thr).req)
	  while (handle_req(esp, &efp->_bk4, efp->_thr), (efp->tmp_esp = *((char **)esp)) != 0) {
	    if ((char *)efp->tmp_esp < (char *)efp)
	      return;
	    efp->tmp_esp = 0;
	    goto LGOTO;
	  }
	while (decomp_rd(esp, &efp->_bk4, efp->_thr, efp->n1_1, efp->n2, efp->n3, efp->b1, efp->b2, efp->a, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	  if ((char *)efp->tmp_esp < (char *)efp)
	    return;
	  efp->tmp_esp = 0;
	  goto LGOTO;
	...
	if (efp->spawned3) {
	  ...
	  merge_task(&(*efp->pthis), efp->a, efp->anx);
	} else
	  while (decomp_rd(esp, &efp->_bk4, efp->_thr, efp->n1_2, efp->n2, efp->n3, efp->b1 + efp->n1_1, efp->b2 + efp->n1_1 * efp->nx, efp->a, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    if ((char *)efp->tmp_esp < (char *)efp)
	      return;
	    efp->tmp_esp = 0;
	    goto LGOTO;
	...
	efp->_bk02 = efp->_bk;
	if ((*efp->_thr).req)
	  while (handle_req(esp, &efp->_bk5, efp->_thr), (efp->tmp_esp = *((char **)esp)) != 0) {
	    if ((char *)efp->tmp_esp < (char *)efp)
	      return;
	    efp->tmp_esp = 0;
	    goto LGOTO;
	  }
	while (decomp_rd(esp, &efp->_bk5, efp->_thr, efp->n1, efp->n2_1, efp->n3, efp->b1, efp->b2, efp->a, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	  if ((char *)efp->tmp_esp < (char *)efp)
	    return;
	  efp->tmp_esp = 0;
	  goto LGOTO;
	...
	if (efp->spawned4) {
	  ...
	  merge_task(&(*efp->pthis2), efp->a + efp->n2_1 * efp->anx, efp->anx);
	} else
	  while (decomp_rd(esp, &efp->_bk5, efp->_thr, efp->n1, efp->n2_2, efp->n3, efp->b1 + efp->n2_1 * efp->nx, efp->b2, efp->a + efp->n2_1 * efp->anx, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	    if ((char *)efp->tmp_esp < (char *)efp)
	      return;
	    efp->tmp_esp = 0;
	    goto LGOTO;
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  efp->anx = anx;
  {
    ...
    while (efp->i < efp->n) {
      efp->n1 = 16;
      if (efp->n1 > efp->n - efp->i) {
	efp->n1 = efp->n - efp->i;
      }
      decomp_d_0(efp->i, efp->n1, efp->a, efp->a + efp->i * efp->nx, efp->nx, efp->anx);
      while (decomp_rd(esp, efp->_bk, efp->_thr, efp->i, efp->n1, efp->n - efp->i, efp->a + efp->i * efp->nx, efp->a + efp->i, efp->a + (efp->i * efp->nx + efp->i), efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
	if ((char *)efp->tmp_esp < (char *)efp)
	  return;
	efp->tmp_esp = 0;
	goto LGOTO;
      }
      decomp_lu_0(efp->n1, efp->a + (efp->i * efp->nx + efp->i), efp->nx, efp->anx);
      decomp_r_0(efp->n1, efp->n - efp->i - efp->n1, efp->a + (efp->i * efp->nx + efp->i), efp->a + (efp->i * efp->nx + efp->i + efp->n1), efp->nx, efp->anx);
      efp->i += 16;
    }
  }
}
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  efp->d = efp->n3;
  efp->nx = efp->n;
  efp->a = (double *)malloc(sizeof(double) * efp->n * efp->n);
  genmat(efp->n, efp->a, efp->nx);
  if (efp->d > 1) {
    printmat(efp->n, efp->a, efp->nx);
  }
  gettimeofday(efp->tp, 0);
  switch (efp->al) {
  case 1:
    decomp_lu_0(efp->n, efp->a, efp->nx, efp->nx);
    break;
  case 2:
    while (decomp_lu(esp, efp->_bk, efp->_thr, efp->n, efp->a, efp->nx, efp->nx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
    ...
    break;
  case 3:
    while (decomp_lu_1(esp, efp->_bk, efp->_thr, efp->n, efp->a, efp->nx, efp->nx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
  ...
  *efp->ansp = elapsed_time(efp->tp);
  fprintf(stderr, "%lf\n", *efp->ansp);
  if (efp->d > 0) {
    efp->l = (double *)malloc(efp->n * efp->n * sizeof(double));
    efp->u = (double *)malloc(efp->n * efp->n * sizeof(double));
    efp->c = (double *)malloc(efp->n * efp->n * sizeof(double));
    if (efp->d > 1) {
      printmat(efp->n, efp->a, efp->nx);
    }
    copy_l(efp->n, efp->a, efp->l, efp->nx);
    copy_u(efp->n, efp->a, efp->u, efp->nx);
    if (efp->d > 1) {
      printmat(efp->n, efp->l, efp->nx);
    }
    if (efp->d > 1) {
      printmat(efp->n, efp->u, efp->nx);
    }
    matmul(efp->n, efp->l, efp->u, efp->c, efp->nx);
    if (efp->d > 1) {
      printmat(efp->n, efp->c, efp->nx);
    }
    genmat(efp->n, efp->a, efp->nx);
    diffmat(efp->n, efp->a, efp->c, efp->nx);
    free(efp->l);
    free(efp->u);
    free(efp->c);
  }
...
LGOTO:
  ...
  *((char **)esp) = 0;
  ...
  efp->a = (*efp->pthis).a;
  efp->nx = (*efp->pthis).nx;
  efp->anx = (*efp->pthis).tmpnx ? (*efp->pthis).tmpnx : (*efp->pthis).anx;
  fprintf(stderr, "start %d\n", (*efp->pthis).tt);
  switch ((*efp->pthis).tt) {
  case TASK_CMD:
    while (proc_cmd(esp, &efp->_bk, efp->_thr, efp->n1, efp->n2, efp->n3, efp->a), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
    ...
    break;
  case TASK_LU:
    while (decomp_lu(esp, &efp->_bk, efp->_thr, efp->n1, efp->a, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
    ...
    break;
  case TASK_R:
    while (decomp_r(esp, &efp->_bk, efp->_thr, efp->n1, efp->n2, efp->b1, efp->a, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
    ...
    break;
  case TASK_D:
    while (decomp_d(esp, &efp->_bk, efp->_thr, efp->n1, efp->n2, efp->b1, efp->a, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
    ...
    break;
  case TASK_RD:
    while (decomp_rd(esp, &efp->_bk, efp->_thr, efp->n1, efp->n2, efp->n3, efp->b1, efp->b2, efp->a, efp->nx, efp->anx), (efp->tmp_esp = *((char **)esp)) != 0) {
      if ((char *)efp->tmp_esp < (char *)efp)
	return;
      efp->tmp_esp = 0;
      goto LGOTO;
...
void            (*task_doers[256]) (char *, struct thread_data *, void *)= {
  (void (*) (char *, struct thread_data *, void *))do_task_lu_task
};
void            (*task_senders[256]) (struct thread_data *, void *)= {
